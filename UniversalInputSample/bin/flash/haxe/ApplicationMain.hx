...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		var projectName = "UniversalInputSample";
		
		var config = {
			
			build: "10",
			company: "... vikingx84",
			file: "UniversalInputSample",
			fps: 60,
			name: "UniversalInputSample",
			orientation: "",
			packageName: "ru.ydvp.UniversalInputSample",
			version: "1.0.0",
			windows: [
		...
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed (projectName, null, 480, 800, config);
		#end
		#else
		create (config);
		#end
